...
\renewcommand\nomgroup[1]{%
\item[\small\bfseries
	\ifstrequal{#1}{W}{Subscripts, superscripts and accents \xheight}{%
	\ifstrequal{#1}{V}{Vector and Matrices \xheight}{%
	\ifstrequal{#1}{S}{Scalars\xheight}{}}}%
]}
%Scalars
 \nomenclature[S]{$n$}{Number of processes of a system}
 \nomenclature[S]{$m$}{Number of flows of a system}
 \nomenclature[S]{$k$}{Unit consumption of a process}
 \nomenclature[S]{$k^*$}{Unit direct exergy cost}
%Vectors and Matrices
 \nomenclature[V]{$\vm{u}_n$}{Unitary vector $(n \times 1)$}
 \nomenclature[V]{$\vm{U}_m$}{Identity matrix $(m \times m)$}
 \nomenclature[V]{$\vm{E}$}{Vector of the exergy of the flows $(m\times1)$}
 \nomenclature[V]{$\vm{F}$}{Vector of the exergy of fuel streams of the  processes $(n\times1)$}
 \nomenclature[V]{$\vm{P}$}{Vector of the exergy of product streams of the processes $(n\times1)$}
 \nomenclature[V]{$\vm{I}$}{Vector of the irreversibility of the processes $(n\times1)$}
 \nomenclature[V]{$\vm{R}$}{Vector of the exergy of wastes generated by the processes $(n\times1)$}
 \nomenclature[V]{$\vm{C}$}{Vector of  generalized exergy costs  $(m\times1)$}
 \nomenclature[V]{$\vm{c}$}{Vector of  generalized unit exergy costs  $(m\times1)$}
 \nomenclature[V]{$\vm{C}_0$}{Vector of  cost of external resources assessed to flows $(m\times1)$}
 \nomenclature[V]{$\vm{Z}$}{Vector of  cost of external resources assessed to process $(n\times1)$}
 \nomenclature[V]{$\mbt{F}$}{Input fuel-process adjacency table $(m\times n)$}
 \nomenclature[V]{$\mbt{R}$}{Waste-process adjacency table $(m\times n)$}
 \nomenclature[V]{$\mbt{P}$}{Output product-process adjacency table $(n\times m)$}
 \nomenclature[V]{$\mbt{V}$}{Input-output flowstream adjacency table $(m\times m)$}
 \nomenclature[V]{$\bm{\nu}_0$}{Vector of exergy of external resources $(m\times 1)$}
 \nomenclature[V]{$\bm{\omega}_s$}{Vector of exergy of final products $(m\times 1)$}
 \nomenclature[V]{$\bm{\omega}_r$}{Vector of exergy of system wastes $(m\times 1)$}
%Subscripts, superscripts and accents
 \nomenclature[W]{t}{Traspose matrix or vector}
 \nomenclature[W]{$\hat{\phantom{x}}$}{Diagonal matrix}
 \nomenclature[W]{*}{Related to direct exergy costs}
 \nomenclature[W]{0}{Related to environment}	
\printnomenclature
\apendix
\section{M-Matrices}
